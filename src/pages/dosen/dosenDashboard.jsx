...
function AnimatedHero({ name }) {
  return (
    ...
    >
      <div
        className="absolute inset-0 animate-[aurora_8s_linear_infinite]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-500">
            ...
            Gunakan dashboard ini untuk mendukung kegiatan akademik dan
        ...
        <div className="rounded-2xl bg-linear-to-br from-slate-900 to-slate-800 p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Modul dosen akan dikembangkan secara bertahap, termasuk EDOM dan
            monitoring mutu akademik.
          </p>
        </div>
      </div>
    </div>
